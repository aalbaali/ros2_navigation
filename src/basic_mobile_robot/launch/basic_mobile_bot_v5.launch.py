...
def generate_launch_description():
    ...
    nav2_bt_path = FindPackageShare(package='nav2_bt_navigator').find('nav2_bt_navigator')  # noqa: E501
    behavior_tree_xml_path = os.path.join(
        nav2_bt_path, 'behavior_trees', 'navigate_w_replanning_and_recovery.xml')  # noqa: E501
    ...
    # Map fully qualified names to relative ones so the node's namespace can be prepended.  # noqa: E501
    # In case of the transforms (tf), currently, there doesn't seem to be a better alternative  # noqa: E501
    ...
    declare_params_file_cmd = DeclareLaunchArgument(
        ...
        description='Full path to the ROS2 parameters file to use for all launched nodes')  # noqa: E501
    ...
    start_ros2_navigation_cmd = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(os.path.join(nav2_launch_dir, 'bringup_launch.py')),  # noqa: E501
