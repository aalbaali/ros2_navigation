...
# This is the launch file used for ROS Foxy and older. Launch this file to
# save a map created in RViz.
import os
...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument("map_saver_params_file", default_value=map_save_config,  # noqa: E501
